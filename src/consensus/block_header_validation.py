...
async def validate_unfinished_header_block(
    ...
    if genesis_block:
        ...
        # Gets the difficulty and IPS for this sub-block
    ...
    if new_sub_slot:
        ...
        for finished_sub_slot_n, sub_slot in enumerate(header_block.finished_sub_slots):
            ...
            if can_finish_epoch and new_sub_slot:
        ...
        if ses_hash is not None:
            ...
            expected_sub_epoch_summary = make_sub_epoch_summary(
                ...
                ips if can_finish_epoch else None,
            )
    ...
    if overflow and can_finish_epoch and len(header_block.finished_sub_slots) < 2:
